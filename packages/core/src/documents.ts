...
import { LoadTypedefsOptions, loadTypedefsUsingLoaders } from './load-typedefs';
...
export async function loadDocumentsUsingLoaders(loaders: Loader[], documentDef: string | string[], options: LoadTypedefsOptions = {}, cwd = process.cwd()): Promise<Source[]> {
